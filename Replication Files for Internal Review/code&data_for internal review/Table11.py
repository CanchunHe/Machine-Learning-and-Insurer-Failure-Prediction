...
if __name__ == "__main__":  
    ...
    ####### Table11 #######
    #load datas
    datas = pd.read_csv(r'subsample\firm information_nonlife.csv')
    ...
    for datatype in ['firm', 'firm+yield', 'firm+macro', 'firm+macro+yield']:
        ...
        Table11 = pd.concat([Table11, auc])

    #save results
    with pd.ExcelWriter('tables and figures/Table11.xlsx') as writer:
        Table11.to_excel(writer,sheet_name='Table11')
