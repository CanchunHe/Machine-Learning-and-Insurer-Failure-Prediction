...
if __name__ == "__main__":  
    ...
    ####### Table12 #######
    #load datas
    datas = pd.read_csv(r'subsample\firm information_dropmergers.csv')
    ...
    for datatype in ['firm', 'firm+yield', 'firm+macro', 'firm+macro+yield']:
        ...
        Table12 = pd.concat([Table12, auc])
        
    #save results
    with pd.ExcelWriter('tables and figures/Table12.xlsx') as writer:
        Table12.to_excel(writer,sheet_name='Table12')
